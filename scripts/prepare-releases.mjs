...
const apps = [
  ...
  { id:'haste', name:'Haste', version:'0.1.0', packageName:'com.example.haste', source:'../Haste/haste/build/app/outputs/flutter-apk/app-debug.apk', expectedHash:'76c7c0e2639a65ae57babaea3daa7028f34bb3f46f1515847febc5457d684b02', notes:'Manual food logging works on-device. AI estimation and USDA lookup need a configured, reachable Haste backend; no public backend is supplied by this download. Account features require Firebase setup. Food logs stay on this device. This development build is intended for local feature testing.' },
