...
const content = {
  sidequest: {
    ...
    intro: 'A little nudge to get together.',
    body: 'The best stories usually start with a plan that actually happened. SideQuest brings the ideas, the planning and the memories into one home for your group.',
    features: [
      ['Find your next thing', 'Browse a shared activity catalogue. Narrow things down by category, cost, duration and group size, or save a good idea for another day.'],
      ['Get everyone on the same page', 'Create a quest or trip, find a date with a poll, collect RSVPs and keep the schedule, bring list and conversation together.'],
      ['Keep the good bits', 'After the plan, keep photos, video, audio, quotes and favourite moments in your private group. Switch between groups without mixing their plans or memories.'],
    ],
  ...
  macrova: {
    ...
    intro: 'Food tracking that leaves room for life.',
    body: 'Not every meal comes with a label. Macrova gives you a place to start with the information you have, understand the assumptions, and decide what goes into your journal.',
    features: [
      ['Start with what you know', 'Combine a photo, a voice description and text. Add portions, ingredients or known nutrition when you have them. Manual entry is available when you already know the values.'],
      ['Have the final say', 'Review the meal description, nutrition, portions and assumptions before saving. Correct the details or ask for a re-evaluation when the AI service is connected. Estimates remain estimates.'],
      ['See your days together', 'Browse food logs by day, edit a meal or repeat a favourite. Track nutrition and weight over time. Food logs stay on the device, separated by account when accounts are configured.'],
    ],
  ...
  revisen: {
    ...
    intro: 'Make your next study session count.',
    body: 'A difficult question is useful information. Revisen helps you keep it, connect it to your course and return to the part you need to practise.',
    features: [
      ['Keep the question', 'Capture a problem from text, a screenshot or your camera. Add your working and the answer key when available, then organise it by course and topic.'],
      ['Connect it to your course', 'Add PDF or text materials and inspect suggested source passages. Confirm the links yourself so each saved question points back to the material that helps explain it.'],
      ['Practise the next step', 'Use calculation-checked numerical practice for supported equations, differentiation, integration and motion questions. Other problems use self-marked original-question practice. Revisit work when it is due.'],
    ],
...
for(const app of manifest.releases){
  ...
  const hero=feature.replace('<h3>','<h1>').replace('</h3>','</h1>').replace(/<a class="text-link"[^]*?<\/a>/,'<a class="button button-dark" href="#test-build">Get the Android test build <span aria-hidden="true">↓</span></a>');
