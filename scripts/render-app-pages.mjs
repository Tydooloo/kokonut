...
const content = {
  ...
  haste: {
    title: 'Haste — Food logging, without the homework',
    description: 'Keep a food journal with photo, voice, text or manual entry. Understand Haste’s estimates and test-build requirements, and download the Android APK.',
    ...
    first: 'Use the local explore flow to try manual food entry, then review and save a meal. Sign in for hosted food search and optional AI estimates.',
    caveat: 'AI estimates can be inaccurate and are subject to daily limits. Explore entries can be temporary, and local food logs do not automatically transfer to another phone.',
  },
  revisen: {
...
writeFileSync('dist/sitemap.xml',`<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">${['','sidequest/','haste/','revisen/','releases/','privacy/'].map(path=>`<url><loc>https://kokonut.cc/${path}</loc></url>`).join('')}</urlset>\n`);
